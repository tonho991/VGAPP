...
function getDivVideos(keys, json){
  ...
  <div class="${generateClass()}">
    <div onclick="window.open('https://vgapp-site.herokuapp.com/videos?id=${idV}','_self')" style="background:#dddbe6;padding:8px;margin-style:solid;border-color:#bcbcbc;margin-bottom:20px;border-radius:5px;">
